...
export const STAR_DESC: Record<string, string> = {
  ...
  'Thiên Phủ': 'Kho tàng tài lộc (Thổ). Được ví là ngân hàng của Mệnh Bàn. Chủ về ổn định, tích lũy, thận trọng từng bước và khả năng bao dung, bảo thủ; chuộng bề ngoài và thường có cuộc sống êm đềm.',
  'Thái Âm': 'Mặt trăng hiền hòa (Thủy). Đại diện cho điền trạch, tài lộc tích lũy sầm uất, nội tâm phong phú và phái nữ (Bà, Mẹ, Vợ). Mang tính chất nhạy cảm, lãng mạn và trân quý tình cảm.',
  'Tham Lang': 'Đào hoa tinh quyến rũ (Mộc/Thủy). Rất mạnh về dục vọng, nghệ thuật, tửu sắc và tài giao tiếp xuất chúng. Khi đứng đắn thì am hiểu triết học, thần học, tu tập, xoay chuyển tình thế.',
  'Cự Môn': 'Ám tinh chủ ngôn ngữ (Thủy). Căn nguyên của thị phi, mâu thuẫn nhưng cũng là sự sắc sảo trong phân tích, phản biện, giảng dạy. "Bệnh tòng khẩu nhập, Ngôn tòng khẩu xuất".',
  'Thiên Tướng': 'Ấn tinh, Ấn tín của Hoàng Đế (Thủy). Trung thành, trượng nghĩa, thích khuôn phép và cái đẹp. Dễ bị hoàn cảnh tác động (chịu ảnh hưởng rất lớn từ các sao hội chiếu).',
  'Thiên Lương': 'Thọ tinh và Ấm tinh (Thổ). Mang phong thái trưởng giả, nghiêm học, luôn che chở người khác hoặc giải cứu tai nạn vào phút chót. Tính nguyên tắc, đôi khi hơi bảo thủ, cố chấp.',
  'Thất Sát': 'Tướng tinh sát phạt (Kim/Hỏa). Xông xáo, dũng mãnh, đầy nhiệt huyết, sẵn sàng đạp đổ rào cản. Thường trải qua gian nan sóng gió mới bộc lộ được uy lực thao lược.',
  'Phá Quân': 'Hao tinh chủ sự phá hoại (Thủy). Tiên phong phá vỡ luật lệ cũ để thiết lập trật tự mới. Liều lĩnh, bạo phát bạo tàn, đòi hỏi sự hy sinh và biến động rất lớn trong đời.',
  ...
  'Địa Kiếp': 'Hại tinh đoạt mệnh (Hỏa). Hao tài tốn của, tai họa ập tới liên tiếp không giữ được thành quả. Nhưng lại ban cho tư duy phá cách phi truyền thống.',
  ...
  'Tấu Thư': 'Sao chủ về giấy tờ, văn bản, ăn nói lưu loát, tài hùng biện và có năng khiếu viết lách.',
  'Phi Liêm': 'Nhanh nhẹn như cánh chim đưa tin, chủ sự thần tốc, phản ứng lẹ và dễ phát sinh thị phi chớp nhoáng. Đi với cát tinh thì thăng tiến nhanh, đi với hung tinh thì tai họa đến gấp, hành động đôi khi hơi sỗ sàng.',
  'Hỷ Thần': 'Sự vui vẻ, kéo dài nụ cười, tăng hỷ khí cho tinh thần. Hay gắn liền với cưới hỏi, thi cử đậu.',
  'Bệnh Phù': 'Nỗi ốm đau nhỏ nhặt, sự suy tư mòn mỏi, nhược điểm sức khỏe.',
  'Đại Hao': 'Mất mát tiền bạc lớn lao, đầu tư sai lầm hoặc thay đổi môi trường sống đột ngột mang tính triệt để.',
  'Phục Binh': 'Ẩn tàng, chờ đợi, có người phục kích chặn đánh hoặc bản thân mưu mô phục kích người khác.',
  'Quan Phủ': 'Quyền hành cai quản, đôi khi hóa giải được giấy tờ luật pháp tùy thuộc vị trí.',
  ...
  'Tử Phù': 'Xấu, thất bại, đeo bám mãi không dứt. Kế hoạch hoặc công việc dễ đi vào ngõ cụt.',
  'Tuế Phá': 'Sự phá hoại sự nghiệp, chống đối bất mãn và ương ngạnh khăng khăng theo ý mình.',
  'Long Đức': 'Đức độ hiền lành, giải cứu tai ương, người cam chịu thiệt thòi để nhường nhịn cho yên chuyện.',
  'Bạch Hổ': 'Tai nạn máu huyết, hình thương, sức mạnh thao lược, uy phong hoặc là nỗi đau buồn tang tóc.',
  'Phúc Đức': 'Phước lộc được hưởng từ kiếp trước, mang tới cơ hội an nhàn, bình giải rủi ro rất êm ái.',
  'Điếu Khách': 'Có tài ăn nói nhưng hay rước họa vào thân, ham mê bài bạc, tụ tập chơi bời, rêu rao.',
  'Trực Phù': 'Sao của sự thẳng thắn, không biết nịnh nọt nên hay chuốc lấy sự thua thiệt, buồn bã bế tắc.',

  // ==========================================
  // TẠP DIỆU, VÒNG TRÀNG SINH & THẦN SÁT KHÁC
  // ==========================================
  'Thiên Mã': 'Đôi ngựa chiến (Hỏa). Chủ về sự dịch chuyển, thay đổi, thăng tiến sự nghiệp, nghị lực và đi công tác xa.',
  'Đào Hoa': 'Bông hoa nở rộ báo hỷ. Sự duyên dáng, lôi cuốn, đào hoa trong nhân tình, năng khiếu nghệ thuật, ham sắc.',
  'Hồng Loan': 'Hôn nhân, sự vui vẻ, mang tính máu huyết, nữ tính và cực kỳ duyên dáng lãng mạn.',
  'Thiên Hỷ': 'Tin vui đột ngột, đám cưới, sinh đẻ. Đôi khi chủ về tính chưng diện, làm đỏm, hài hước.',
  'Thiên Hình': 'Luật pháp, hình khắc, uy quyền, quân đao, sẹo vết mổ xẻ trên người. Đóng đúng chỗ là Quan Tư Tướng Giác.',
  'Thiên Diêu': 'Ngôi sao lẳng lơ, chơi bời, xảo quyệt nhưng cũng đem tới sức quyến rũ chết người và khiếu đồng bóng.',
  'Thiên Riêu': 'Tương tự Thiên Diêu. Ngôi sao lẳng lơ, chơi bời, quyến rũ và mang tính chất đào hoa phong lưu.',
  'Thiên Y': 'Y khoa, phương tiện thuốc men, người mát tay trong chữa trị bệnh tật.',
  ...
  'Thiên Vu': 'Sao chủ về di sản, thừa kế, tín ngưỡng, tôn giáo hoặc khả năng tâm linh.',
  ...
  'Mộc Dục': 'Giai đoạn tẩy trần (tắm rửa). Tượng trưng cho sự bấp bênh, đào hoa, hay chải chuốt và thích hư vinh.',
  'Quan Đới': 'Khoác áo đội mũ. Mang khí thế vươn lên, tìm hướng đi, khởi đầu sự thành đạt và cầu tiến.',
  'Lâm Quan': 'Làm quan nhận tước. Tự lập thịnh vượng, vui vẻ, có uy danh, cuộc sống vượng phát mạnh mẽ.',
  'Đế Vượng': 'Giai đoạn cực thịnh chói lọi. Tinh thần oai phong, cái tôi cực kỳ cường đại, danh lợi đủ đầy nhưng là đỉnh dốc chuẩn bị tuột.',
  'Suy': 'Bắt đầu xuống dốc. Sự suy lực, mệt mỏi, thiếu chí tiến thủ, nhưng lại chín chắn trầm mặc, ít bốc đồng.',
  'Bệnh': 'Yếu ớt sinh bệnh. Thiếu sinh khí, dễ buồn rầu, ốm đau thường xuyên, tâm hồn hay dao động.',
  'Tử': 'Cái chết tĩnh mịch. Mọi sự đình trệ, bảo thủ, khép kín, làm việc hay bỏ dở dang.',
  'Mộ': 'Nấm mồ chôn vùi. Chủ về sự gom góp, tàng trữ bủn xỉn, ngu muội nhưng lại rất tốt về đường tích tụ tài sản.',
  'Tuyệt': 'Tuyệt diệt. Vạn vật cắt đứt để chuyển sinh. Làm việc dễ vô vọng, thích phá tan cái cũ, dễ rơi vào bế tắc tột cùng.',
  'Thai': 'Hoài thai ấp ủ. Ngu ngơ khờ dại, hay làm lại từ đầu trắc trở, có sự ngây thơ tinh khôi.',
  'Dưỡng': 'Nuôi nấng bồi dưỡng. Tâm tính an phận, sức lớn từ từ, phụ thuộc nhiều nhưng biết cưu mang.',
};

/**
 * Hàm lấy String chi tiết của một Sao. Tự động chuẩn hóa từ vựng (Fallback).
 */
export const getStarDescription = (name: string): string => {
  ...
  if (cleanName.includes('Triệt')) return STAR_DESC['Triệt Không'];
